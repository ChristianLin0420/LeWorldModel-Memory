...
def _publish_pair(json_path: Path, json_payload: bytes,
    ...
    _require(json_path.resolve() != tex_path.resolve(),
...
def main(
        ...
        recompute_formal_audit: Callable[
            [Mapping[str, Any]], Mapping[str, Any]] | None = None) -> int:
    ...
    ledger["publication_artifacts"] = {
        "tex": {
            "path": _display_path(args.tex_output),
    ...
    publication = _publish_pair(
        args.json_output, json_payload, args.tex_output, tex_payload,
