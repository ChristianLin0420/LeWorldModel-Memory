...
def replacements(a: dict[str, dict]) -> dict[str, str]:
    ...
    values: dict[str, str] = {
        ...
        "X1_T1_DIFF": fmt(x1["per_task_mean_diff"]["t1"], 4, sign=True),
        "X1_T3_DIFF": fmt(x1["per_task_mean_diff"]["t3"], 4, sign=True),
        "X1_T4_DIFF": fmt(x1["per_task_mean_diff"]["t4"], 4, sign=True),
        ...
        "X2_DETUNED_SUCCESS": fmt(x2_mean("rfix_detuned_argmax")),
